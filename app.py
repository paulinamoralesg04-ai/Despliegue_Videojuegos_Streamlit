# -*- coding: utf-8 -*-
"""Despliegue_Regresión.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1j-d7IPT3JfPrq3sIUgiqadTqwYc5_4qZ
"""

#Cargamos librerías principales
#no se pueden poner comentarios en texto
import numpy as np
import pandas as pd
...
#esta libreria simula codigo html en python
#es un formulario que simula, es decir, esto es lo que entrego en vez de los datos
...
#siempre se hace para asegurar de que esten todos los datos
data_preparada=data_preparada.reindex(columns=variables,fill_value=0)
data_preparada.head()

#Se normaliza la edad para predecir con Knn, Red o MSV
